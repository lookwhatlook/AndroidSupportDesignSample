...
import com.abc.designsample.Main3Activity;
...
public class FragmentOne extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        TextView tv = (TextView) getView().findViewById(R.id.tv_fragment);
        tv.setText(mParam2);
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                onButtonPressed("OOOOO");
            }
        });
        ...
        RecyclerAdapter mAdapter = new RecyclerAdapter(list, getActivity());
        // 为mRecyclerView设置适配器
